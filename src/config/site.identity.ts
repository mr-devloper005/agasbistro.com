export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'agasbistro',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Agas Bistro',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'agasbistro.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://agasbistro.com',
